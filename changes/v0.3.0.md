...
<img alt="Horizontal niri-inspired layout" width="760" src="https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/layout-niri.png">
...
- **Clip actions (mod+K).** Rename, close, move, or resize the focused clip from one panel, even over a live terminal.
...
**Live terminal, server-rendered.** Terminals render as an HTML grid with per-line diff patching, so only the lines that change repaint. URLs are clickable, even when they wrap across lines. Wide characters line up. Apps that clear the screen redraw cleanly.
