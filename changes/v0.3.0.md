...
![Live terminal pane](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/terminal.png)

**Themeable colors.** Pick a terminal palette from the top bar. Themes are plain CSS variables, so adding one is a few lines.

![Theme picker](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/theme.png)

**One top bar.** The top and status bars are merged. New and Actions handles are always visible.

![Top bar](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/topbar.png)

**Faster new clips.** A top-right dropdown creates clips. Type to pick the kind, no mouse needed.

![New-clip dropdown](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/newclip.png)

**Clip actions on Cmd-K.** Rename or close the focused clip from one panel, even over a live terminal.

![Clip-actions panel](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/actions.png)

**Scrollable stack layout.** Each stack lays out as a horizontal strip you can scroll. Alt+L toggles it.

![Scrollable niri layout](https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/layout-niri.png)
