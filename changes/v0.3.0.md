...
stacks2099 is the [stacks](https://github.com/cablehead/stacks) tool-for-thought, rebuilt on [cross.stream](https://github.com/cablehead/xs) and [Datastar](https://data-star.dev). This release builds out the workspace around that core: layout, theming, a single top bar, and a server-rendered terminal.
...
<img alt="Server-rendered terminal pane" width="700" src="https://raw.githubusercontent.com/cablehead/stacks2099/main/changes/v0.3.0/terminal.png">
